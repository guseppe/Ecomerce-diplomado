package com.example.ecomerce_diplomado.services;
...
public class FirebaseService {
    ...
    private static final String URL_DOWNLOAD = "gs://diplomado-ecomerce-images.appspot.com/images/ecomerce";
    private static final String PATH_UPLOAD = "images/ecomerce";
    private static final long ONE_MEGABYTE = 1024 * 1024;

    private static FirebaseService sInstance;

    public static FirebaseService obtain() {
        if (sInstance == null) {
    ...
    public void download(final String key, final Response.Listener response, final Response.ErrorListener errorListener) {
        ...
        // final Bitmap bitmap = imageCache.getBitmapFromCache(key);
//        if (bitmap != null) {
//            Log.e(TAG, "Bitmap in memory");
